#if !defined( __RUI_ELDADUST_RWNDPROC_H__ )
#define __RUI_ELDADUST_RWNDPROC_H__
//-----------------------------------------------------------------------------
#include "FrameWnd.h"
#include "Button.h"
#include "ImageBox.h"
...
class CItemEldaDustRWndProc : public CWndProc
{
public:
	CItemEldaDustRWndProc(){}
	~CItemEldaDustRWndProc(){}
...
extern	CItemEldaDustRWndProc	g_ItemEldaDust_RWndProc;
//-----------------------------------------------------------------------------
#endif  __RUI_ELDADUST_RWNDPROC_H__