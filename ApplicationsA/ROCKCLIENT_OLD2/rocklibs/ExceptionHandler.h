//**********************************************************************
//
//	RockBase의 BSU가 정상작동 안해서.. 임시로 사용하는 Crash Handler
//
//**********************************************************************
...
{
	SAFE_STR_CPY(g_ExceptionBuffer, ".\\CrashLog", 256);
	_mkdir(g_ExceptionBuffer);
	GetLocalTime(&g_Exception_systime);
	sprintf(g_ExceptionBuffer, ".\\CrashLog\\%04d-%02d-%02d-%02d-%02d-%02d.txt",
