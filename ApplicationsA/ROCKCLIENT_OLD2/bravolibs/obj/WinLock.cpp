// WinLock.cpp: implementation of the CWinLock class.
/***********************************************************************
...
void CWinLock::SetHInstance( HINSTANCE hInstance )
{
 ...
 * (Win9x/NT/2K/XP)      *
 *************************/
int CWinLock::Desktop_Show_Hide(BOOL bShowHide)
{
	OSVERSIONINFO	osvi;
 ...
 * (Win9x/NT/2K/XP)        *
 ***************************/
int CWinLock::StartButton_Show_Hide(BOOL bShowHide)
{
    HWND    hWnd;
 ...
 * (Win9x/NT/2K/XP)      *
 *************************/
int CWinLock::Taskbar_Show_Hide(BOOL bShowHide)
{
    HWND    hWnd;
 ...
 * (Win9x/NT/2K/XP)        *
 ***************************/
int CWinLock::Clock_Show_Hide(BOOL bShowHide)
{
    HWND    hWnd;
 ...
 * (Win 9x)                                                 *
 ************************************************************/
int CWinLock::Keys_Enable_Disable(BOOL bEnableDisable)
{
    BOOL    bOldState;
 ...
 * ( Win ?)                         *
 ************************************/
int CWinLock::AltTab1_Enable_Disable(BOOL bEnableDisable)
{
    BOOL    bOldState;
 ...
 * (Win 2K)                         *
 ************************************/
int CWinLock::AltTab2_Enable_Disable(HWND hWnd, BOOL bEnableDisable)
{
 ...
 * (Win NT4SP3+, Win2K).                             *
 *****************************************************/
int CWinLock::TaskSwitching_Enable_Disable(BOOL bEnableDisable)
{
    if (!bEnableDisable)
    {
        if (!hKeyboardHook)
 ...
 * (Win NT/2K/XP)                       *
 ****************************************/
int CWinLock::TaskManager_Enable_Disable(BOOL bEnableDisable)
{
 ...
 * (Win 2K).                                                     *
 *****************************************************************/
int CWinLock::CtrlAltDel_Enable_Disable(BOOL bEnableDisable)
{
 ...
 * (Win NT+).                                   *
 ************************************************/
int CWinLock::Thread_Desktop(LPTHREAD_START_ROUTINE ThreadFunc, THREAD_DATA *td)
{
 ...
 * (Win NT+).                                    *
 *************************************************/
int CWinLock::Process_Desktop(char *szDesktopName, char *szPath)
{
	HDESK	hOriginalThread;
	HDESK	hOriginalInput;
	HDESK	hNewDesktop;
