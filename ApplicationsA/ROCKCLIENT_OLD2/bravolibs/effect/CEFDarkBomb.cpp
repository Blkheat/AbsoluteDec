...
void CEFDarkBomb::Init(void)
{
	...
	if( ( pData = g_Particle.m_ParticleData.GetKeyDataPointer( 24672 ) ) == NULL )
		return;
	m_BallParticle[0].MakeLink(pData);

	if( ( pData = g_Particle.m_ParticleData.GetKeyDataPointer( 24673 ) ) == NULL )
		return;
...
int CEFDarkBomb::Render(float dtime)
{
...
int CEFDarkBomb::CheckFrame(void)
{
	return TRUE;
}

int CEFDarkBomb::Update(float dtime)
{
	if( !g_Particle.m_EffectManager.CheckCharacter( m_pSrcChr) )
	{
		SetDestroy(TRUE);
...
// 이펙트 처리후 뒤로올 이펙트 셋업
//................................................................................................................
int CEFDarkBomb::SetAfterEffect(void)
{
