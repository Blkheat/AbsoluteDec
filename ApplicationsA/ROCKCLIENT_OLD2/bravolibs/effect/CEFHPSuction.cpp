...
void CEFHPSuction::Init(void)
{
	...
	if( ( pData = g_Particle.m_ParticleData.GetKeyDataPointer( 22009 ) ) == NULL )
		return;
	...
	g_Particle.SetEffSetCon( 0.0f , EF_HP_SUCTION   , 0 , 2.1f , m_pSrcChr->GetUnique()  , m_pSrcChr->GetIndex() );
	g_Particle.SetEffSetCon( 0.0f , EF_HP_SUCTIONED , 0 , 2.1f , 
							 m_pDestChr->GetUnique() , m_pDestChr->GetIndex(), ::GetCharPos(D3DXVECTOR3(0.0f, 0.0f, 0.0f), m_pSrcChr) );
}


int CEFHPSuction::Render(float dtime)
{
	D3DXMATRIX matLocal;	
...
int CEFHPSuction::Update(float dtime)
{
	if( !g_Particle.m_EffectManager.CheckCharacter( m_pSrcChr , m_pDestChr ) )
	{
		SetDestroy(TRUE);
...
// 이펙트 처리후 뒤로올 이펙트 셋업
//................................................................................................................
int CEFHPSuction::SetAfterEffect(void)
{
	//................................................................................	
	// 어택 사운드
	//................................................................................	
