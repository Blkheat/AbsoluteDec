                                    ...
                                    DWORD* pdwVertexShader )
{
    ...
    hr = g_RenderManager.CreateVertexShader( pdwVertexDecl, 
                                 ...
                                 BOOL bAddWatermark )
{
	...
	if( FAILED( hr = pd3dDevice->CreateOffscreenPlainSurface( dwWidth, dwHeightDest, 
        D3DFMT_A8R8G8B8, D3DPOOL_SCRATCH, &pCursorBitmap, NULL ) ) )
#else 
	if( FAILED( hr = g_RenderManager.CreateImageSurface( dwWidth, dwHeightDest, 
